...
V implementaciji vektorski del kvaterniona $a$ pridobimo s funkcijo $quat\_vec(a)$, sklararni del pa kar z ukazom $a(1)$. Kvaterniona $a$ in $b$ seštejemo z ukazom $a+b$, njun produkt pa kličemo s funkcjio $quatmultiply(a,b)$. Konjugirano vrednost kvaterniona $a$ pridobimo s klicom funkcije $conj\_quat(a)$.
\end{opomba}
...
%QUATMULTIPLY izracuna produkt dveh kvaternionov, kot je opisano v teoreticnem delu
%
% Input:
% a ... prvi kvaternion
% b ... drugi kvaternion
...
\begin{lstlisting}[caption = {\color{green} quat\_exp}]
