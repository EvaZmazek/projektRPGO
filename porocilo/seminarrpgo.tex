...
\noindent Pri opiisovanju rotacij si lahko pomagamo s \textbf{kvaternioni}. Prostor kvaternionov $\H$ je $4$-dimenzionalni vektorski prostor s standardno bazo
...
$$\mathcal{A} \cdot \mathcal{B}  = (a_0 b_0 - \underline{a} \underline{b}, a_0 \underline{b} + b_0 \underline{a} + \underline{a} \times \underline{b}$$
...
\noindent Z uporabo konematične preslikave lahko za konstrukcijo sferičnih gibanj uporabimo Bezierjeve krivulje.

\noindent Izberemo kontrolne kvaternione $a_0,a_1,\dots,a_n$
